      ...
      <div className="flex justify-between py-10 items-center px-5 lg:px-28 lg:flex-row flex-col-reverse">
        ...
        >
          ...
          >
            ...
            <motion.h2 variants={{ hidden: { opacity: 0, y: 10 }, visible: { opacity: 1, y: 0 } }}>
              Based on <span className="font-extrabold">Jakarta.</span>
            </motion.h2>
          </motion.div>
          ...
          >
            Passionate about technology, I specialize in Data Analysis and Data Visualization. I focus on transforming raw data into meaningful insights, building data-driven solutions, and continuously expanding my analytical skills. My goal is to grow as a data analyst and contribute to impactful, insight-driven projects.
          </motion.p>
